...
class PanelView extends XComponentView {
   ...
   function __construct($model) {
      ...
      XPage::addScript('managers/adm_portal/templates/js/viewer.js');
      XPage::addScript('managers/adm_portal/templates/js/manager.js');
      XPage::addStylesheet('managers/adm_portal/templates/css/main.css');
