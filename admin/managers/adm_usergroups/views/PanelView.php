...
class PanelView extends XComponentView {
   ...
   function __construct($model) {
      ...
      XPage::addScript('managers/adm_usergroups/templates/js/viewer.js');
      XPage::addScript('managers/adm_usergroups/templates/js/manager.js');
      XPage::addStylesheet('managers/adm_usergroups/templates/css/main.css');
