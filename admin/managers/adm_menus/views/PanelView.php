...
class PanelView extends XComponentView {
   ...
   function __construct($model) {
      ...
      XPage::addScript('managers/adm_menus/templates/js/viewer.js');
      XPage::addScript('managers/adm_menus/templates/js/manager.js');
      XPage::addStylesheet('managers/adm_menus/templates/css/main.css');
