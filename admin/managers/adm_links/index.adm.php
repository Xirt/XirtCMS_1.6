...
class Manager extends XComponent {
   ...
   function showNormal() {
      ...
      XContent::addCSSTag('managers/adm_links/css/main.css');
      XContent::addScriptTag('managers/adm_links/js/manager.js');
      XContent::addScriptTag('managers/adm_links/js/viewer.js');
