...
class PanelView extends XComponentView {
   ...
   function __construct($model) {
      ...
      XPage::addScript('managers/adm_components/templates/js/viewer.js');
      XPage::addScript('managers/adm_components/templates/js/manager.js');
      XPage::addStylesheet('managers/adm_components/templates/css/main.css');
